let Antenna,Contract,Web3,contractInfo,eventABI;_84d‍.w("iotex-antenna",[["default",["Antenna"],function(v){Antenna=v}]]);_84d‍.w("iotex-antenna/lib/contract/contract",[["Contract",["Contract"],function(v){Contract=v}]]);_84d‍.w("web3",[["default",["Web3"],function(v){Web3=v}]]);_84d‍.w("./contract",[["default",["contractInfo"],function(v){contractInfo=v}]]);_84d‍.w("./eventABIs",[["default",["eventABI"],function(v){eventABI=v}]]);//jshint esversion:8
...
const getTimeStamp = async (actionHash) => {
    try {
        ...
        _84d‍.g.console.log(JSON.stringify(action.actionInfo[0].timestamp));
...
(async () => {
    ...
    let actionHashForCreation = await createDID("0x2afeca511b4a2c809225196c40ff0c1db5d1da243428c9ece2c60d256b7d2a92", "someUri", "");
    _84d‍.g.console.log(actionHashForCreation);
    ...
    _84d‍.g.console.log("LOG when new did is created: ", log);
    ...
    _84d‍.g.console.log("remind did string: ", didString); //did:io:0xd29694ef9654e7296ebbfcfd7f5aba2050fc0b80

    let hash = await getHash(didString);
    _84d‍.g.console.log("Get document hash: ", hash); //0x2afeca511b4a2c809225196c40ff0c1db5d1da243428c9ece2c60d256b7d2a92
    let uri = await getURI(didString);
    _84d‍.g.console.log("get uri: ", uri); //someUri
    ...
    _84d‍.g.console.log("action hash for updateHash: ", actionHashForUpdateHash);
    await wait(15000);
    let logForupdatHash = await readLog(eventABI.updateHashEvent, actionHashForUpdateHash);
    _84d‍.g.console.log("log for action hash: ", logForupdatHash); //0x6b22041934973b8dc2d68181b87f18ef085f739c793a99dd72062f97ec4e3c4f


    let actionHashForUpdateURI = await updateURI("did:io:0xd29694ef9654e7296ebbfcfd7f5aba2050fc0b80", "new updated uri!");
    _84d‍.g.console.log(actionHashForUpdateURI);
    await wait(15000);
    let logForupdatURI = await readLog(eventABI.updateURIEvent, actionHashForUpdateURI);
    _84d‍.g.console.log("action hash for updateURI", logForupdatURI); //new updated uri!
    ...
    _84d‍.g.console.log("action hash for delte", actionHashForDelete);
    await wait(10000);
    let logForDelete = await readLog(eventABI.deleteEvent, actionHashForDelete);
    _84d‍.g.console.log("Log when did is deleted! ", logForDelete);
